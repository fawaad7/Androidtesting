						...
						<div class="panel panel-default">
							<div class="panel-body">
								...
								<div class="input-group">
									<input type="search" name="search" class="form-control" placeholder="Search  For Something....">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="form-group">
									...
									<div class="col-sm-7">
										<input type="text" id="username" placeholder=" Email Address" name="user_name" class="form-control">
									</div>
								</div>
								<div class="form-group">
