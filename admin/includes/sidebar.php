<div class="col-lg-2">
			<ul class="navbar navbar-default nav" style="height:650px;">
				...
				<li><a href="#new_items" data-toggle="collapse"><i class="glyphicon glyphicon-plus"></i> New Items</a>
					<ul id="new_items" class="nav collapse" >
						<li><a href="new_post.php"><i class="glyphicon glyphicon-pencil"></i> New Post</a></li>
						<li><a href="new_category.php"><i class="glyphicon glyphicon-edit"></i> New Category</a></li>
					</ul>
				</li>
